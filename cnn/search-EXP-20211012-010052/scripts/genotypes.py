...
DARTS_SEED2 = Genotype(
    normal=[('dil_conv_5x5', 1), 
    ('sep_conv_3x3', 0), ('dil_conv_3x3', 2), 
    ('dil_conv_5x5', 1), ('dil_conv_5x5', 2), 
    ('dil_conv_3x3', 3), ('max_pool_3x3', 3), 
    ('skip_connect', 4)], normal_concat=range(2, 6), 
    reduce=[('avg_pool_3x3', 1), 
    ('sep_conv_5x5', 0), ('sep_conv_3x3', 2), 
    ('sep_conv_3x3', 1), ('avg_pool_3x3', 2), 
    ('max_pool_3x3', 3), ('sep_conv_3x3', 4), 
    ('sep_conv_5x5', 3)], reduce_concat=range(2, 6))

DARTS_SEED83 = Genotype(
