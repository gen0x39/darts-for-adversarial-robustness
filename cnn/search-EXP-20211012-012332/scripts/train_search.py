...
from attack import FastGradientSignUntargeted, FastGradientSignUntargetedForArchitectureSearch
...
def train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, start, epoch):
    ...
    attack = FastGradientSignUntargetedForArchitectureSearch(model, args.epsilon, _type='l2')
